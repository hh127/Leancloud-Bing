...
//生成bigimg
var bigImgStr = `
            <img data-src="https://bing-api.avosapps.us/api/?day=${daydata}" src="https://bing-api.avosapps.us/api/?day=${daydata}&thumbnail=1" class="d-block w-100 rounded preview lazy" alt="bing">
`
...
function getImgMsg(day) {
    ...
    $.ajax({
        type: "GET",
        async: false,
        url: "https://bing-api.avosapps.us/api/",
...
//将数据写入模态框
var modalImgStr = `
<img class="rounded img-fluid" src="https://bing-api.avosapps.us/api/?day=${daydata}" alt="">
`
